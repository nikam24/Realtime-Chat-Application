        ...
        <form>
          ...
          <div className="text-center lg:text-left">
            <button
              ...
              data-te-ripple-init
              data-te-ripple-color="light" onClick={onLogin}>
              Login
            </button>
            <p className="mt-2 mb-0 pt-1 text-sm font-semibold">
              Don't have an account?
              <NavLink classNameName="text-danger transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700"
       to="/signup">
                                Sign up
                            </NavLink>
            </p>
              ...
              <div className="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
                <form>
                  <div className="flex flex-row items-center justify-center lg:justify-start">
                    ...
                    >
                      <svg
                        xmlns="client\public\facebookicon.png"
                        className="mx-auto h-3.5 w-3.5"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                      >
                        <path d="client\public\facebookicon.png" />
                        <img src="client\public\facebookicon.png" alt="" />
                      </svg>
                    </button>
                  ...
                  <div className="relative mb-6" data-te-input-wrapper-init>
                    <input
                      className="peer block min-h-[auto] w-full rounded border border-gray-400 bg-transparent py-[0.32rem] px-3 leading-[2.15] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-black dark:placeholder:text-black [&:not([data-te-input-placeholder-active])]:placeholder:opacity-70"
                      id="email-address"
                      name="email"
                      type="email"
                      required
                  ...
                  <div className="text-center lg:text-left">
                    ...
                    <p className="mt-2 mb-0 pt-1 text-sm font-semibold">
                      Don't have an account?&nbsp;
                      <NavLink
                        classNameName="text-danger transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700"
                        to="/signup"
                      >
                          Sign up
                      </NavLink>
